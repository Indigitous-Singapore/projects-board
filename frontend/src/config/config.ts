export default {
  'organisation': process.env.organisation || 'Indigitous Singapore',
  'organisationMobile': process.env.organisationMobile || '',
  'organisationEmail': process.env.organisationEmail || 'developer@indigitous.sg',
